...
require (
	cloud.google.com/go v0.0.0-20170629112852-7c205da84d8d // indirect
	github.com/Microsoft/go-winio v0.4.11 // indirect
	github.com/Microsoft/hcsshim v0.0.0-20190129145542-bc49f75c7221
	...
	k8s.io/client-go v0.0.0-20170829130306-a95edf803628
